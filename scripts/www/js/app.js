        ...
        return new Promise((resolve, reject) => {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    reject(new Error('文件解析失败，请确保Excel文件格式正确'));
                }
            };
...
// 添加Android WebView兼容性修复
if (window.AndroidInterface) {
    // 如果存在Android接口，使用Android的文件选择器
    document.getElementById('importBtn').addEventListener('click', function() {
        if (window.AndroidInterface && window.AndroidInterface.selectFile) {
            window.AndroidInterface.selectFile();
        } else {
            document.getElementById('importExcel').click();
        }
    });
